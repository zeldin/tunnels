...
public:
  ...
  virtual void setPlayerHP(unsigned n, byte HP) = 0;
  ...
  virtual void resetQuestObjects() = 0;
  ...
  virtual void resetEncounterProbability() = 0;
  virtual byte getRations() const = 0;
  virtual void setRations(byte rations) = 0;
  virtual void setInitialRations() = 0;
  virtual void resetRationTurns() = 0;
  virtual void resetRationInterval() = 0;
  virtual void resetUnknown1118() = 0;
  virtual void resetHealingInterval() = 0;
  virtual void resetHealingTurns() = 0;
  virtual void resetSubtime() = 0;
  virtual void resetUnknown111C() = 0;
  virtual void resetUnknown111D() = 0;
  virtual void setCurrentMagicalEffect(TimedMagicalEffect effect) = 0;
  virtual void setCurrentMagicalEffect(TimedMagicalEffect effect, byte t) = 0;
  virtual bool expireCurrentMagicalEffect(TimedMagicalEffect effect) = 0;
  ...
  virtual byte getClassInitialGold(unsigned n) const = 0;
  virtual byte getClassInitialEquipment(unsigned n, unsigned &m, ItemCategory &cat) const = 0;
  ...
  virtual byte getStartFloor() const = 0;
  virtual byte getKeymapEntry(KeyMapping k) const = 0;
  virtual byte getDefaultWeaponDamage() const = 0;
  ...
  virtual void setUnknown10FA(byte x) = 0;
  virtual byte getUnknown10FB() const = 0;
  virtual void setUnknown10FB(byte x) = 0;
  ...
  virtual void setUnknown10FF(byte x) = 0;
  virtual MapPosition getEntryStairsPosition() const = 0;
  virtual DescriptorHandle getRoomDescriptor(MapPosition pos) const = 0;
  virtual DescriptorHandle getFirstRoomDescriptor(MapPosition &pos) const = 0;
  ...
  virtual void digFloor() = 0;
  virtual void stockFloor() = 0;
